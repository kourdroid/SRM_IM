...
// ⚡ Bolt: Hoisted pure function outside component to prevent re-allocation on every render
...
export default function UserManagement() {
  ...
  // ⚡ Bolt: Memoized handler to prevent re-renders in FlatList items
  ...
  // ⚡ Bolt: Memoized renderItem to prevent unnecessary re-renders of all list items
  ...
  }, [approvalUpdatingId, updateApproval, handleDeleteUser]);
