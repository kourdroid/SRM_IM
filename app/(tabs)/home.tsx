...
// Format incident date for display - Hoisted to prevent re-allocation
...
// Parse media URLs - Hoisted to prevent re-allocation
...
export default function Home() {
  ...
  }, [hasMore, isLoadingMore, incidents, fetchIncidents]);
