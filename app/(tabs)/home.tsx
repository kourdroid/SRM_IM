...
export default function Home() {
  ...
  // ⚡ Bolt: wrap with useCallback to prevent recreating on every render
  ...
  // ⚡ Bolt: extract and memoize onEndReached to prevent FlatList from receiving new function references
  ...
  // ⚡ Bolt: memoize renderItem to prevent inline allocations on re-renders
