...
// --- Hoisted Pure Functions for Performance ---
...
const extractIncidentKey = (item: Incident) => String(item.id);
// ----------------------------------------------
...
export default function Home() {
  ...
  }, [setSelectedIncident, setIsModalVisible, setShowClosureMaterials, setClosureMaterialRows, db, setSelectedIncidentMaterials]);
      ...
      {/* List Container */}
        ...
        {isLoading ? (
          ...
          <FlatList
            ...
            keyExtractor={extractIncidentKey}
