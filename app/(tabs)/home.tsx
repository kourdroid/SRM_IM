...
// Helper functions moved outside component scope to prevent reallocation on every render (Performance Optimization)
...
export default function Home() {
  ...
  // Wrap renderIncidentItem in useCallback to prevent unnecesary recreations of the function and
  // prevent re-renders of the FlatList items (Performance Optimization)
