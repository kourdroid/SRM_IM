...
export default function Home() {
  ...
  // Wrapped `renderIncidentItem` with `useCallback` to prevent unnecessary re-renders of list items in `FlatList`.
  // Expected Impact: Reduces re-renders and memory allocations, resulting in smoother scrolling.
