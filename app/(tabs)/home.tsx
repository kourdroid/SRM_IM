...
export default function Home() {
  ...
  // Wrap onEndReached in useCallback for FlatList performance
  ...
  // Memoize helper function used in FlatList renderItem
  ...
  // Wrap renderItem in useCallback for FlatList performance
