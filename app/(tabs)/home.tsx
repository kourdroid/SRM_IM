...
// ⚡ Bolt: Hoisted pure helper functions outside component to prevent re-allocation on every render
...
export default function Home() {
  ...
  }, []); // Using useCallback to prevent unnecessary re-renders of list items
