...
export default function Home() {
  ...
  // Bolt Optimization: Extract onEndReached to maintain stable reference and avoid list re-renders
  ...
  // Bolt Optimization: Memoize renderItem to prevent unnecessary re-renders of list items
