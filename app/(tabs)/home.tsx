...
// Helper functions hoisted outside component to prevent re-creation
...
export default function Home() {
  ...
  // Optimized: Wrapped in useCallback to prevent FlatList re-renders on parent state changes
